    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('pop', 'Pop'), ('classical', 'Classical')], default='pop', max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listens', to='music.song')),
            ],
        ),
        migrations.CreateModel(
            name='LikeHistory',
