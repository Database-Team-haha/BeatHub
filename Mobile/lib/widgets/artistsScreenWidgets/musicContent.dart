    ...
    return Column(
      children: [
        ListView.builder(
              ...
              return InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => PlayingScreen(title: Songs.songDetails[widget.name]![index].name, image: Songs.songDetails[widget.name]![index].image, name: widget.name, id: Songs.songDetails[widget.name]![index].id,))
                  );},
          ...
          itemCount: Songs.songDetails[widget.name]?.length ?? 0,
          primary: false,
          shrinkWrap: true,
